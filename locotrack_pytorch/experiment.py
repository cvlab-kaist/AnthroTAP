...
try:
    ...
    # If KubricData is unavailable, define a placeholder to avoid import errors.
    KubricData = None
    print('Kubric repository not found. Please clone https://github.com/google-research/kubric.git for using Kubric training dataset.')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--mode', type=str, required=True, help="Mode to run: 'train' or 'eval', optionally with the 'q_first' flag and the evaluation dataset name.")
    parser.add_argument('--ckpt_path', type=str, default=None, help="Path to the checkpoint file.")
    parser.add_argument('--save_path', type=str, default='snapshots', help="Path to save logs and checkpoints.")
